  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-2xl p-12 max-w-xl mx-auto"
      >
        <div className="text-center mb-10">
          ...
          >
            <FaSignInAlt className="h-16 w-16 text-blue-500 mb-4" />
          </motion.div>
        ...
        <div className="mt-8">
          <motion.button
            whileHover={{ scale: 1.05, rotate: 2 }} // Phóng to nhỏ và xoay nhẹ khi hover
            whileTap={{ scale: 0.95 }} // Thu nhỏ khi nhấn
          ...
          >
            <motion.span
              whileHover={{ scale: 1.1 }} // Phóng to icon khi hover
              transition={{ type: "spring", stiffness: 300 }}
        ...
        <div className="mt-6 text-lg text-gray-600 text-center">
          ...
          <button onClick={onOpenRegister} className="text-blue-500 hover:underline ml-1">
            Register Now
          </button>
        </div>
