...
app.post("/upload", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    console.log("📜 Extracted PDF Content:", rawText.slice(0, 500)); // Debug nội dung PDF
    ...
    console.log("📤 Sending to Gemini API for summary...");
    const summary = await callGeminiAPI(truncatedContent, "document");
    console.log("✅ Summary:", summary);

    res.json({ originalText: truncatedContent, summary });
